...
/**
 * A DTO for the Essenza entity.
 */
public class EssenzaDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EssenzaDTO essenzaDTO = (EssenzaDTO) o;
        if (essenzaDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), essenzaDTO.getId());
    }
