...
import cloud.nino.nino.service.custom.CustomEmailService;
...
public class MailService {
    ...
    public MailService(JHipsterProperties jHipsterProperties, JavaMailSender javaMailSender,
                       ...
                       CustomEmailService customEmailService, ServiceConfig serviceConfig) {
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        emailDTO.setTo(to);
        emailDTO.setFrom(serviceConfig.getEmailFrom());
        emailDTO.setSubject(subject);
        emailDTO.setHtmlBody(content);
        this.customEmailService.send(emailDTO);
    }
