...
import cloud.nino.nino.config.audit.AuditEventConverter;
import cloud.nino.nino.domain.PersistentAuditEvent;
...
import static cloud.nino.nino.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
