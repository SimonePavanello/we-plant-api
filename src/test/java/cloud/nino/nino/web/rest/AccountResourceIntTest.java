...
import cloud.nino.nino.config.Constants;
import cloud.nino.nino.domain.Authority;
import cloud.nino.nino.domain.User;
import cloud.nino.nino.repository.AuthorityRepository;
import cloud.nino.nino.repository.UserRepository;
import cloud.nino.nino.security.AuthoritiesConstants;
import cloud.nino.nino.service.MailService;
import cloud.nino.nino.service.UserService;
import cloud.nino.nino.service.custom.PrivacyCustomService;
import cloud.nino.nino.service.dto.PasswordChangeDTO;
import cloud.nino.nino.service.dto.UserDTO;
import cloud.nino.nino.service.mapper.UserMapper;
import cloud.nino.nino.web.rest.errors.ExceptionTranslator;
import cloud.nino.nino.web.rest.vm.KeyAndPasswordVM;
import cloud.nino.nino.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    @Mock
    private PrivacyCustomService privacyCustomService;
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, userMapper, privacyCustomService);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, userMapper, privacyCustomService);
