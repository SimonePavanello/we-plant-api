...
describe('Service Tests', () => {
    describe('Stop Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(StopService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/stops';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Stop', () => {
                service.create(new Stop(null)).subscribe(received => {
            ...
            it('should update a Stop', () => {
                service.update(new Stop(123)).subscribe(received => {
